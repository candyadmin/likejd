...
//	}
	if (this.remember) {
		var regex = new RegExp(COOKIE_PRE+"sdmenu_" + encodeURIComponent(this.menu.id) + "=([01]+)");
...
SDMenu.prototype.memorize = function() {
	if (this.remember) {
		...
		document.cookie = COOKIE_PRE+"sdmenu_" + encodeURIComponent(this.menu.id) + "=" + states.join("") + "; expires=" + d.toGMTString() + "; path=/";
	}
};