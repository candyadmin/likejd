...
$(function(){
	...
	$('.checkitem').click(function(){
		var bool;
		//如果全选选中，点击单个checkbox，则全选取消
		if($(this).attr('checked')!='checked'&&$('.checkall').attr('checked')=='checked'){
			$('.checkall').attr('checked',false);
		}else if($(this).attr('checked')=='checked'&&$('.checkall').attr('checked')!='checked'){
			$('.checkitem').each(function(){
